...
echo.                                      %p%░░░╚═╝░░░╚═╝░░╚══════╝╚══════╝░╚════╝░░╚════╝░╚═╝░░░░░╚═╝╚══════╝░
echo.                        %b%"══════════════════════════════════════════════════════════════════════════════════════════════════"%w%                                                                                                  
echo.                                    %w%  Made by EXM TWEAKS® 2024 %b%║%w% Version 5.0 %b%║%w% updated 3d of August 2024           
echo.                                                                                                   
echo.
...
cls
chcp 437 >nul 2>&1
powershell -Command "& {Add-Type -AssemblyName System.Windows.Forms; [System.Windows.Forms.MessageBox]::Show('Downloading rescourses (power plan, Nvidia profile inspector & more)', 'Exm Tweaking Utility', 'Ok', [System.Windows.Forms.MessageBoxIcon]::Information);}"
...
powershell -Command "& {Add-Type -AssemblyName System.Windows.Forms; [System.Windows.Forms.MessageBox]::Show('Downloaded rescourses successfully', 'Exm Tweaking Utility', 'Ok', [System.Windows.Forms.MessageBoxIcon]::Information);}"
...
echo.                        %W% 
echo.                        %W%                           %p%%w%%p%%w%                                  %p%[%w%13%p%]%w% Fix Corrupted Files               
echo.                        %W%                                                                                                                      
echo.                        %b%"════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════"
echo.                        %W%                                                                                                                      
echo.                        %W%                           %p%[%w%R%p%]%w% Reverts         %p%[%w%W%p%]%w% Unlock your PC's Full Performance       %p%[%w%P%p%]%w% Use Restore Point                                             
echo.                        %W%                                                                                                                                          
echo.                        %W%                                                                                                                                                                           
echo.                        %W%                                  Made by EXM TWEAKS® 2024 %b%║%w% Discord.gg/exm %b%║%w% Updated 3d of august                                    
echo.                        %W%                                                                                                                  
echo.                        %b%"════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════"
...
:r11
start https://www.microsoft.com/en-us/edge?ep=313&form=MA13M0&es=40
echo.
echo.
echo.
echo.                                              %b%"═══════════════════════════════════════════════════════"

...
Title HydraOS Preboot Install Script Made By Hydra[Dont Move Mouse]
...
PowerRun.exe /SW:0 Reg.exe delete "HKCR\DesktopBackground\Shell\PowerPlan_WAT" /f
devmanview /disable "HID Keyboard Device"
...
PowerRun.exe /SW:0 reg.exe add "HKLM\SOFTWARE\Microsoft\PowerShell\1\ShellIds\Microsoft.PowerShell" /v "ExecutionPolicy" /t REG_SZ /d "Unrestricted" /f
cls

echo Changing Language

:: Set the default input method to en-US
powershell -Command "Set-WinDefaultInputMethodOverride -InputTip '0409:00000409'"

:: Get the list of current input methods and remove the Latin American keyboard layout (es-419)
powershell -Command "$inputMethods = Get-WinUserLanguageList; $inputMethods = $inputMethods | Where-Object { $_.InputMethodTips -ne '040A:0000040A' }; Set-WinUserLanguageList $inputMethods -Force"

:: Set the system UI language to en-US
powershell -Command "Set-WinUILanguageOverride -Language en-US"

:: Set the system locale to en-US
powershell -Command "Set-WinSystemLocale -SystemLocale en-US"

echo Disabling UAC
PowerRun.exe /SW:0 Reg.exe add "HKLM\SOFTWARE\Microsoft\Windows\CurrentVersion\Policies\System" /v "EnableLUA" /t REG_DWORD /d "0" /f
PowerRun.exe /SW:0 Reg.exe add "HKLM\SOFTWARE\Microsoft\Windows\CurrentVersion\Policies\System" /v "PromptOnSecureDesktop" /t REG_DWORD /d "0" /f
PowerRun.exe /SW:0 Reg.exe add "HKLM\SOFTWARE\Microsoft\Windows\CurrentVersion\Policies\System" /v "ConsentPromptBehaviorAdmin" /t REG_DWORD /d "0" /f
PowerRun.exe /SW:0 Reg.exe add "HKLM\SOFTWARE\Microsoft\Windows\CurrentVersion\Policies\System" /v "ValidateAdminCodeSignatures" /t REG_DWORD /d "0" /f
cls
...
powerrun "schtasks.exe" /change /disable /TN "Microsoft\Windows\Active Directory Rights Management Services Client\AD RMS Rights Policy Template Management (Manual)" /Disable
powerrun "schtasks.exe" /change /disable /TN "Microsoft\Windows\AppID\EDP Policy Manager" /Disable
powerrun "schtasks.exe" /change /disable /TN "Microsoft\Windows\Application Experience\StartupAppTask" /Disable
powerrun "schtasks.exe" /change /disable /TN "Microsoft\Windows\ApplicationData\appuriverifierdaily" /Disable
powerrun "schtasks.exe" /change /disable /TN "Microsoft\Windows\ApplicationData\appuriverifierinstall" /Disable
powerrun "schtasks.exe" /change /disable /TN "Microsoft\Windows\ApplicationData\DsSvcCleanup" /Disable
powerrun "schtasks.exe" /delete /f /tn "Microsoft\Windows\AppListBackup\Backup" /F
powerrun "schtasks.exe" /delete /f /tn "Microsoft\Windows\AppListBackup\BackupNonMaintenance" /F
powerrun "schtasks.exe" /delete /f /tn "Microsoft\Windows\AppListBackup" /F
powerrun "schtasks.exe" /change /disable /TN "Microsoft\Windows\BrokerInfrastructure\BgTaskRegistrationMaintenanceTask" /Disable
powerrun "schtasks.exe" /change /disable /TN "Microsoft\Windows\CloudExperienceHost\CreateObjectTask" /Disable
powerrun "schtasks.exe" /change /disable /TN "Microsoft\Windows\Data Integrity Scan\Data Integrity Check And Scan" /Disable
powerrun "schtasks.exe" /change /disable /TN "Microsoft\Windows\Device Setup\Metadata Refresh" /Disable
powerrun "schtasks.exe" /change /disable /TN "Microsoft\Windows\DeviceDirectoryClient\HandleCommand" /Disable
powerrun "schtasks.exe" /change /disable /TN "Microsoft\Windows\DeviceDirectoryClient\HandleWnsCommand" /Disable
powerrun "schtasks.exe" /change /disable /TN "Microsoft\Windows\DeviceDirectoryClient\IntegrityCheck" /Disable
powerrun "schtasks.exe" /change /disable /TN "Microsoft\Windows\DeviceDirectoryClient\LocateCommandUserSession" /Disable
powerrun "schtasks.exe" /change /disable /TN "Microsoft\Windows\DeviceDirectoryClient\RegisterDeviceAccountChange" /Disable
powerrun "schtasks.exe" /change /disable /TN "Microsoft\Windows\DeviceDirectoryClient\RegisterDeviceLocationRightsChange" /Disable
powerrun "schtasks.exe" /change /disable /TN "Microsoft\Windows\DeviceDirectoryClient\RegisterDevicePeriodic24" /Disable
powerrun "schtasks.exe" /change /disable /TN "Microsoft\Windows\DeviceDirectoryClient\RegisterDevicePolicyChange" /Disable
powerrun "schtasks.exe" /change /disable /TN "Microsoft\Windows\DeviceDirectoryClient\RegisterDeviceProtectionStateChanged" /Disable
powerrun "schtasks.exe" /change /disable /TN "Microsoft\Windows\DeviceDirectoryClient\RegisterDeviceSettingChange" /Disable
powerrun "schtasks.exe" /change /disable /TN "Microsoft\Windows\DeviceDirectoryClient\RegisterUserDevice" /Disable
powerrun "schtasks.exe" /change /disable /TN "Microsoft\Windows\InstallService\ScanForUpdates" /Disable
powerrun "schtasks.exe" /change /disable /TN "Microsoft\Windows\InstallService\ScanForUpdatesAsUser" /Disable
powerrun "schtasks.exe" /change /disable /TN "Microsoft\Windows\InstallService\SmartRetry" /Disable
powerrun "schtasks.exe" /change /disable /TN "Microsoft\Windows\Wininet\CacheTask" /Disable
powerrun "schtasks.exe" /change /disable /TN "Microsoft\Windows\Management\Provisioning\Cellular" /Disable
powerrun "schtasks.exe" /change /disable /TN "Microsoft\Windows\Management\Provisioning\Logon" /Disable
powerrun "schtasks.exe" /change /disable /TN "Microsoft\Windows\PushToInstall\Registration" /Disable
powerrun "schtasks.exe" /change /disable /TN "Microsoft\Windows\Printing\PrinterCleanupTask" /Disable
powerrun "schtasks.exe" /change /disable /TN "Microsoft\Windows\SoftwareProtectionPlatform\SvcRestartTask" /Disable
powerrun "schtasks.exe" /change /disable /TN "Microsoft\Windows\SoftwareProtectionPlatform\SvcRestartTaskLogon" /Disable
powerrun "schtasks.exe" /change /disable /TN "Microsoft\Windows\SoftwareProtectionPlatform\SvcRestartTaskNetwork" /Disable
powerrun "schtasks.exe" /change /disable /TN "Microsoft\Windows\StateRepository\MaintenanceTasks" /Disable
...
set BACKUP="%systemdrive%\HydraOS\System Configuration\Services Backup\Windows-DefaultServices.reg"
...
echo KnownDLLs clean
PowerRun.exe /SW:0 Reg.exe delete "HKLM\SYSTEM\CurrentControlSet\Control\Session Manager\KnownDLLs" /v "_wow64cpu" /f
PowerRun.exe /SW:0 Reg.exe delete "HKLM\SYSTEM\CurrentControlSet\Control\Session Manager\KnownDLLs" /v "_wowarmhw" /f
PowerRun.exe /SW:0 Reg.exe delete "HKLM\SYSTEM\CurrentControlSet\Control\Session Manager\KnownDLLs" /v "_xtajit" /f
PowerRun.exe /SW:0 Reg.exe delete "HKLM\SYSTEM\CurrentControlSet\Control\Session Manager\KnownDLLs" /v "wow64" /f
PowerRun.exe /SW:0 Reg.exe delete "HKLM\SYSTEM\CurrentControlSet\Control\Session Manager\KnownDLLs" /v "wow64base" /f
PowerRun.exe /SW:0 Reg.exe delete "HKLM\SYSTEM\CurrentControlSet\Control\Session Manager\KnownDLLs" /v "wow64con" /f
PowerRun.exe /SW:0 Reg.exe delete "HKLM\SYSTEM\CurrentControlSet\Control\Session Manager\KnownDLLs" /v "wow64win" /f
PowerRun.exe /SW:0 Reg.exe delete "HKLM\SYSTEM\CurrentControlSet\Control\Session Manager\KnownDLLs" /v "xtajit64" /f
cls

Echo Installing VisualCRedist
CD /d %~dp0
"%WinDir%\Modules\VisualCRedist\VisualCppRedist_AIO_x86_x64" /ai /gm2 >nul 2>&1
start /wait "" "%WinDir%\Modules\VisualCRedist\vcredist2015_2017_2019_x86.exe" /passive /norestart /q
start /wait "" "%WinDir%\Modules\VisualCRedist\vcredist2015_2017_2019_x64.exe" /passive /norestart /q
cls

echo Installing DirectX
start /wait "" "%WinDir%\Modules\directx\DXSETUP.exe" /silent
cls

echo Installing Openshell
start /b /wait "" "%systemdrive%\windows\Modules\OpenShell.exe" /qn ADDLOCAL=StartMenu >nul 2>&1
cls
...
copy /y "%systemdrive%\Windows\Modules\Skins\Immersive.skin" "%systemdrive%\Program Files\Open-Shell\Skins"
copy /y "%systemdrive%\Windows\Modules\Skins\Immersive.skin7" "%systemdrive%\Program Files\Open-Shell\Skins"
del "%systemdrive%\Program Files\Open-Shell\start screen.lnk"
del "%systemdrive%\users\%username%\AppData\Roaming\Openshell\Pinned\startscreen.lnk"
...
reg import "%systemdrive%\Windows\Modules\openshell.reg"
...
cd %systemdrive%\Windows\SystemApps\Microsoft.Windows.Search_cw5n1h2txyewy
takeown /f "searchapp.exe"
icacls "%systemdrive%\Windows\SystemApps\Microsoft.Windows.Search_cw5n1h2txyewy\searchapp.exe" /grant Administrators:F
...
Reg.exe add "HKLM\SOFTWARE\Policies\Microsoft\Windows\QoS\VALORANT" /v "Application Name" /t REG_SZ /d "VALORANT-Win64-Shipping.exe" /f > NUL 2>&1
...
::fortnite
Reg.exe add "HKLM\SOFTWARE\Policies\Microsoft\Windows\QoS\FORTNITE" /v "Version" /t REG_SZ /d "1.0" /f > NUL 2>&1
Reg.exe add "HKLM\SOFTWARE\Policies\Microsoft\Windows\QoS\FORTNITE" /v "Application Name" /t REG_SZ /d "FortniteClient-Win64-Shipping.exe" /f > NUL 2>&1
Reg.exe add "HKLM\SOFTWARE\Policies\Microsoft\Windows\QoS\FORTNITE" /v "Protocol" /t REG_SZ /d "*" /f > NUL 2>&1
Reg.exe add "HKLM\SOFTWARE\Policies\Microsoft\Windows\QoS\FORTNITE" /v "Local Port" /t REG_SZ /d "*" /f > NUL 2>&1
Reg.exe add "HKLM\SOFTWARE\Policies\Microsoft\Windows\QoS\FORTNITE" /v "Local IP" /t REG_SZ /d "*" /f > NUL 2>&1
Reg.exe add "HKLM\SOFTWARE\Policies\Microsoft\Windows\QoS\FORTNITE" /v "Local IP Prefix Length" /t REG_SZ /d "*" /f > NUL 2>&1
Reg.exe add "HKLM\SOFTWARE\Policies\Microsoft\Windows\QoS\FORTNITE" /v "Remote Port" /t REG_SZ /d "*" /f > NUL 2>&1
Reg.exe add "HKLM\SOFTWARE\Policies\Microsoft\Windows\QoS\FORTNITE" /v "Remote IP" /t REG_SZ /d "*" /f > NUL 2>&1
Reg.exe add "HKLM\SOFTWARE\Policies\Microsoft\Windows\QoS\FORTNITE" /v "Remote IP Prefix Length" /t REG_SZ /d "*" /f > NUL 2>&1
Reg.exe add "HKLM\SOFTWARE\Policies\Microsoft\Windows\QoS\FORTNITE" /v "DSCP Value" /t REG_SZ /d "46" /f > NUL 2>&1
Reg.exe add "HKLM\SOFTWARE\Policies\Microsoft\Windows\QoS\FORTNITE" /v "Throttle Rate" /t REG_SZ /d "-1" /f > NUL 2>&1
::cs2
Reg.exe add "HKLM\SOFTWARE\Policies\Microsoft\Windows\QoS\CS2" /v "Version" /t REG_SZ /d "1.0" /f > NUL 2>&1
Reg.exe add "HKLM\SOFTWARE\Policies\Microsoft\Windows\QoS\CS2" /v "Application Name" /t REG_SZ /d "cs2.exe" /f > NUL 2>&1
Reg.exe add "HKLM\SOFTWARE\Policies\Microsoft\Windows\QoS\CS2" /v "Protocol" /t REG_SZ /d "*" /f > NUL 2>&1
Reg.exe add "HKLM\SOFTWARE\Policies\Microsoft\Windows\QoS\CS2" /v "Local Port" /t REG_SZ /d "*" /f > NUL 2>&1
Reg.exe add "HKLM\SOFTWARE\Policies\Microsoft\Windows\QoS\CS2" /v "Local IP" /t REG_SZ /d "*" /f > NUL 2>&1
Reg.exe add "HKLM\SOFTWARE\Policies\Microsoft\Windows\QoS\CS2" /v "Local IP Prefix Length" /t REG_SZ /d "*" /f > NUL 2>&1
Reg.exe add "HKLM\SOFTWARE\Policies\Microsoft\Windows\QoS\CS2" /v "Remote Port" /t REG_SZ /d "*" /f > NUL 2>&1
Reg.exe add "HKLM\SOFTWARE\Policies\Microsoft\Windows\QoS\CS2" /v "Remote IP" /t REG_SZ /d "*" /f > NUL 2>&1
Reg.exe add "HKLM\SOFTWARE\Policies\Microsoft\Windows\QoS\CS2" /v "Remote IP Prefix Length" /t REG_SZ /d "*" /f > NUL 2>&1
Reg.exe add "HKLM\SOFTWARE\Policies\Microsoft\Windows\QoS\CS2" /v "DSCP Value" /t REG_SZ /d "46" /f > NUL 2>&1
Reg.exe add "HKLM\SOFTWARE\Policies\Microsoft\Windows\QoS\CS2" /v "Throttle Rate" /t REG_SZ /d "-1" /f > NUL 2>&1
cls

echo Region Settings
Reg.exe add "HKEY_CURRENT_USER\Control Panel\International\Geo" /v "Name" /t REG_SZ /d "PL" /f > NUL 2>&1
Reg.exe add "HKEY_CURRENT_USER\Control Panel\International\Geo" /v "Nation" /t REG_SZ /d "191" /f > NUL 2>&1
Reg.exe add "HKEY_CURRENT_USER\Control Panel\International" /v "sTimeformat" /t REG_SZ /d "HH:mm:ss" /f > NUL 2>&1
Reg.exe add "HKEY_CURRENT_USER\Control Panel\International" /v "sYearMonth" /t REG_SZ /d "MMMM yyyy" /f > NUL 2>&1
Reg.exe add "HKEY_CURRENT_USER\Control Panel\International" /v "sShortTime" /t REG_SZ /d "HH:mm" /f > NUL 2>&1
Reg.exe add "HKEY_CURRENT_USER\Control Panel\International" /v "sShortDate" /t REG_SZ /d "dd.MM.yyyy" /f > NUL 2>&1
cls

echo Optimizing bcdedit entries
bcdedit /set {current} description "HydraOS22H2"
...
PowerRun.exe /SW:0 Reg.exe delete "HKLM\SOFTWARE\Microsoft\Windows\CurrentVersion\Explorer\Desktop\NameSpace\{B2B4A4D1-2754-4140-A2EB-9A76D9D7CDC6}" /f
for %%z in (
	NfsClnt
	NfsRdr
	RpcXdr
...
powercfg -import "%systemdrive%\windows\modules\Hydra_Best_Plan.pow" 33333333-3333-3333-3333-333333333333
...
%systemdrive%\Windows\PowerRun.exe "powershell.exe" Remove-AutologgerConfig -Name "autologger-diagtrack-listener", "cellcore", "cloudexperiencehostoobe", "lwtnetlog", "mellanox-Kernel", "microsoft-windows-assignedaccess-trace", "microsoft-windows-rdp-graphics-rdpidd-trace"
cls
...
:copy as path 
reg add "HKCR\AllFilesystemObjects\shellex\ContextMenuHandlers\CopyAsPathMenu" /ve /t REG_SZ /d "" /f
:Take ownership
...
Reg.exe add "HKLM\SOFTWARE\Microsoft\Windows\CurrentVersion\Run" /v "TimerResolution" /t REG_SZ /d "%systemdrive%\Windows\modules\timerres.exe --resolution 5070 --no-console" /f
cls
...
Reg.exe add "HKCU\Control Panel\Accessibility\ToggleKeys" /v "Flags" /t REG_SZ /d "50" /f
Reg.exe add "HKCU\Control Panel\Accessibility\Keyboard Response" /v "Flags" /t REG_SZ /d "114" /f
cls

echo Changing System Responsiveness
...
PowerRun.exe /SW:0 Reg.exe add "HKLM\SOFTWARE\Microsoft\Windows\CurrentVersion\EditionOverrides" /v "UserSetting_DisableStartupSound" /t REG_DWORD /d "1" /f
cls

echo GPU Settings
Reg add "HKEY_CURRENT_USER\Software\Microsoft\DirectX\GraphicsSettings" /v "SwapEffectUpgradeCache" /t REG_DWORD /d "1" /f
Reg add "HKEY_CURRENT_USER\Software\Microsoft\DirectX\UserGpuPreferences" /v "DirectXUserGlobalSettings" /t REG_SZ /d "SwapEffectUpgradeEnable=1;VRROptimizeEnable=0;" /f
Reg add "HKLM\SYSTEM\CurrentControlSet\Control\GraphicsDrivers" /v "HwSchMode" /t REG_DWORD /d "1" /f
cls

echo Disabling Snapping
reg.exe add "HKEY_CURRENT_USER\Control Panel\Desktop" /v "WindowArrangementActive" /t REG_SZ /d "0" /f
cls
...
echo Disabling SleepStudy
reg add "HKLM\SYSTEM\CurrentControlSet\Control\Session Manager\Power" /v "SleepStudyDisabled" /t REG_DWORD /d "1" /f
cls

echo Disabling Feeds
PowerRun.exe /SW:0 Reg.exe delete "HKCU\SOFTWARE\Microsoft\Windows\CurrentVersion\Feeds" /f
cls

echo Disabling online tips
PowerRun.exe /SW:0 Reg.exe add "HKLM\SOFTWARE\Microsoft\Windows\CurrentVersion\Policies\Explorer" /v "AllowOnlineTips" /t REG_DWORD /d "0" /f
cls

echo Disabling automatic maintenance
PowerRun.exe /SW:0 Reg.exe add "HKLM\SOFTWARE\Microsoft\Windows NT\CurrentVersion\Schedule\Maintenance" /v "MaintenanceDisabled" /t REG_DWORD /d "1" /f
cls

echo Disabling Widgets
PowerRun.exe /SW:0 Reg.exe add "HKLM\SOFTWARE\Policies\Microsoft\Dsh" /v "AllowNewsAndInterests" /t REG_DWORD /d "0" /f
cls

echo Disabling fault tolerant heap
PowerRun.exe /SW:0 Reg.exe add "HKLM\SOFTWARE\Microsoft\FTH" /v "Enabled" /t REG_DWORD /d "0" /f
cls

echo Disabling powershell telemetry
PowerRun.exe /SW:0 Reg.exe add "HKLM\SYSTEM\CurrentControlSet\Control\Session Manager\Environment" /v "POWERSHELL_TELEMETRY_OPTOUT" /t REG_SZ /d "1" /f
cls

echo Disabling remote assistance
PowerRun.exe /SW:0 Reg.exe add "HKLM\SYSTEM\CurrentControlSet\Control\Remote Assistance" /v "fAllowToGetHelp" /t REG_DWORD /d "0" /f
cls

echo Disabling gamebar
PowerRun.exe /SW:0 Reg.exe add "HKLM\SOFTWARE\Microsoft\WindowsRuntime\ActivatableClassId\Windows.Gaming.GameBar.PresenceServer.Internal.PresenceWriter" /v "ActivationType" /t REG_DWORD /d "0" /f
cls

echo Installing Runtimes
start /wait "" "%WinDir%\Modules\runtime.exe" /quiet
cls

echo Event log tweaks
...
PowerRun.exe /SW:0 reg.exe delete "HKLM\SYSTEM\WaaS" /f
cls

echo Audio Settings
reg add "HKCU\Software\Microsoft\Multimedia\Audio" /v "UserDuckingPreference" /t REG_DWORD /d "3" /f >nul 2>&1
reg add "HKLM\SOFTWARE\WOW6432Node\Microsoft\Windows\CurrentVersion\Authentication\LogonUI\BootAnimation" /v "DisableStartupSound" /t REG_DWORD /d "1" /f >nul 2>&1
PowerRun.exe /SW:0 Reg.exe add "HKLM\SOFTWARE\Microsoft\Windows\CurrentVersion\Authentication\LogonUI\BootAnimation" /v "DisableStartupSound" /t REG_DWORD /d "1" /f
...
echo Hiding Settings
reg add "HKLM\SOFTWARE\Microsoft\Windows\CurrentVersion\Policies\Explorer" /v "SettingsPageVisibility" /t REG_SZ /d "hide:home;cortana;privacy-automaticfiledownloads;privacy-feedback;windowsinsider;windowsupdate;deviceusage;gaming-gamemode;maps;otherusers;backup;findmydevice;windowsdefender;privacy;gaming-gamebar;gaming-gamedvr;gaming-broadcasting" /f
cls
...
icacls "%systemdrive%\Windows\System32\mcupdate_AuthenticAMD.dll" /grant Administrators:F
ren mcupdate_AuthenticAMD.dll mcupdate_AuthenticAMD.old
takeown /f "mcupdate_GenuineIntel.dll"
icacls "%systemdrive%\Windows\System32\mcupdate_GenuineIntel.dll" /grant Administrators:F
ren mcupdate_GenuineIntel.dll mcupdate_GenuineIntel.old
cls

echo Renaming Mobsync
cd %systemdrive%\Windows\System32
...
echo Disabling Gamebar enabling FSE
...
Reg.exe add "HKLM\SOFTWARE\Microsoft\Windows\CurrentVersion\Run" /v "ForcePauseUpdate" /t REG_SZ /d "Regedit.exe /s \"%systemdrive%\Windows\modules\forcepauseupdate.reg\"" /f
cls

Echo Installing 7zip
start /b /wait "" "%systemdrive%\Windows\Modules\7zip.msi" /q INSTALLDIR="%systemdrive%\Program Files\7-Zip" >nul 2>&1
reg import "%systemdrive%\Windows\Modules\7zip.reg"
cls
...
echo Creating Default Services Backup
set BACKUP="%systemdrive%\HydraOS\System Configuration\Services Backup\HydraOS-DefaultServices.reg"
echo Windows Registry Editor Version 5.00 >>%BACKUP%
...
echo applying Zero Delay Tweaks
...
Reg.exe add "HKCU\SOFTWARE\Microsoft\GameBar" /v "AllowAutoGameMode" /t REG_DWORD /d "1" /f
Reg.exe add "HKCU\SOFTWARE\Microsoft\GameBar" /v "AutoGameModeEnabled" /t REG_DWORD /d "1" /f
Reg.exe add "HKLM\SYSTEM\CurrentControlSet\Control\GraphicsDrivers" /v "HwSchMode" /t REG_DWORD /d "0" /f
...
REG ADD "HKLM\SYSTEM\CurrentControlSet\Services\DXGKrnl" /F /V "MonitorLatencyTolerance" /T REG_DWORD /d 0
REG ADD "HKLM\SYSTEM\CurrentControlSet\Services\DXGKrnl" /F /V "MonitorRefreshLatencyTolerance" /T REG_DWORD /d 0
REG ADD "HKEY_LOCAL_MACHINE\SYSTEM\CurrentControlSet\Services\USB" /F /V "DisableSelectiveSuspend" /T REG_DWORD /d 1
Reg.exe add "HKLM\SYSTEM\CurrentControlSet\Services\Tcpip\Parameters" /v "MaxConnectionsPer1_0Server" /t REG_DWORD /d "16" /f
Reg.exe add "HKLM\SYSTEM\CurrentControlSet\Services\Tcpip\Parameters" /v "MaxConnectionsPerServer" /t REG_DWORD /d "16" /f
Reg.exe add "HKLM\SYSTEM\CurrentControlSet\Services\Tcpip\Parameters" /v "DisableTaskOffload" /t REG_DWORD /d "00000000" /f
Reg.exe add "HKLM\SYSTEM\CurrentControlSet\Services\Tcpip\Parameters" /v "EnableConnectionRateLimiting" /t REG_DWORD /d "00000000" /f
...
Reg.exe add "HKLM\SYSTEM\CurrentControlSet\Control\Session Manager\Memory Management" /v "MoveImages" /t REG_DWORD /d "0" /f
Reg.exe add "HKLM\Software\Microsoft\FTH" /v "Enabled" /t REG_DWORD /d "0" /f
echo. %g%[+] %z% Applying Ultimate optimization Tweaks now!
timeout 1 > nul
reg add "HKLM\SOFTWARE\Policies\Microsoft\Windows\Windows Error Reporting" /v "Disabled" /t REG_DWORD /d "1" /f 
reg add "HKLM\SOFTWARE\Policies\Microsoft\Windows\Windows Error Reporting" /v "DoReport" /t REG_DWORD /d "0" /f 
reg add "HKLM\SOFTWARE\Policies\Microsoft\Windows\Windows Error Reporting" /v "LoggingDisabled" /t REG_DWORD /d "1" /f 
...
reg add "HKLM\SOFTWARE\Policies\Microsoft\Windows\DWM" /v "DisallowAnimations" /t REG_DWORD /d 0 /f
reg add "HKCU\SOFTWARE\Microsoft\Windows\CurrentVersion\Explorer\Advanced" /v "TaskbarAnimations" /t REG_DWORD /d "0" /f
...
echo.
@RD /S /Q "C:\Users\Administrator\AppData\Local\Discord\Update.exe" >NUL 2>&1
@RD /S /Q "C:\Users\Administrator\AppData\Local\Discord\Discord_updater_rCURRENT.log" >NUL 2>&1
@RD /S /Q "C:\Users\Administrator\AppData\Local\Discord\chrome_100_percent.pak" >NUL 2>&1
@RD /S /Q "C:\Users\Administrator\AppData\Local\Discord\chrome_200_percent.pak" >NUL 2>&1
cd %HOMEPATH%\AppData\Local\Discord\app-1.0.9013\modules\
...
wmic process where ProcessId=%pid% CALL setpriority "realtime"
cls
echo %g%[+] %z%Applying Debloat (May take awhile so please wait the program did not crash or freeze)
PowerShell -Command "Get-AppxPackage *3DBuilder* | Remove-AppxPackage"
...
echo Setting Device Cleaner
Reg.exe add "HKLM\SOFTWARE\Microsoft\Windows\CurrentVersion\Run" /v "Device cleaner" /t REG_SZ /d "%systemdrive%\Windows\modules\device cleaner.bat" /f
start "1" "explorer"
cls
Reg.exe add "HKLM\SOFTWARE\Microsoft\Windows\CurrentVersion\Runonce" /v "explorerfix" /t REG_SZ /d "%systemdrive%\Windows\modules\2.bat"
reg add "HKEY_CURRENT_USER\Software\Microsoft\Windows\CurrentVersion\Search" /v SearchboxTaskbarMode /t REG_DWORD /d 0 /f
reg add "HKLM\SOFTWARE\Microsoft\Windows\CurrentVersion\Winlogon" /v ShutdownColor /t REG_DWORD /d 0x000000FF /f
reg add "HKCU\Control Panel\Desktop" /v "AutoColorization" /t REG_DWORD /d 0x000000FF /f
reg add "HKCU\Control Panel\Desktop" /v "ColorPrevalence" /t REG_DWORD /d 0x00000001 /f
del %systemdrive%\windows\modules\Hydra_Best_Plan.pow
del %systemdrive%\windows\modules\VisualCRedist\* /s /q
rmdir %systemdrive%\windows\modules\VisualCRedist
del %systemdrive%\windows\modules\7zip.reg
del %systemdrive%\windows\modules\7zip.msi
del %systemdrive%\windows\modules\DirectX\* /s /q
rmdir %systemdrive%\windows\modules\DirectX
del %systemdrive%\windows\DirectX.log
del %systemdrive%\windows\DtcInstall.log
del %systemdrive%\windows\WindowsUpdate.log
del %systemdrive%\windows\lsasetup.log
del %systemdrive%\windows\modules\runtime.exe
del /q/f/s %TEMP%\*
...
devmanview /enable "HID Keyboard Device"
cls

shutdown -r -t 5 /c "Rebooting HydraOS"
